...
#ifndef _apt32f101_i2c_H
#define _apt32f101_i2c_H
...
/******************************************************************************
************************** I2C IO Simulation Definition ***********************
******************************************************************************/
#define SDA_PIN         (0)                                    //PA0.0SDA
#define SCL_PIN         (1)                                    //PA0.1 SCL

#define SDA_H  (GPIO_Write_High(GPIOA0,SDA_PIN))               //GPIOA0 or GPIOB0
#define SDA_L  (GPIO_Write_Low(GPIOA0,SDA_PIN))
#define SCL_H  (GPIO_Write_High(GPIOA0,SCL_PIN))
#define SCL_L  (GPIO_Write_Low(GPIOA0,SCL_PIN))

#define SDA_IN  (GPIO_Init(GPIOA0,0,1))           //PIN_0~7, Lowbyte  PIN_8~15, Highbyte,1=INPUT 0=OUTPUT
#define SDA_OUT (GPIO_Init(GPIOA0,0,0))
#define SCL_IN  (GPIO_Init(GPIOA0,1,1))
#define SCL_OUT (GPIO_Init(GPIOA0,1,0))
#define SDA_STATUS (GPIO_Read_Status(GPIOA0,SDA_PIN))
...
extern volatile uint8_t I2CWrBuffer[BUFSIZE],I2CRdBuffer[BUFSIZE];
#endif   /**< apt32f101_i2c_H */
