...
#ifndef _apt32f101_gtc_H
#define _apt32f101_gtc_H
...
typedef enum
{
	...
	GTC_ControlSet_CAPT_F			=	((CSP_REGISTER_T)0X01ul<<17),					//When Falling Edge of External Input Signal is Detected,Current Counter Value is Stored into the Capture Down Register.
	GTC_ControlSet_CAPT_R			=	((CSP_REGISTER_T)0X01ul<<18),					//When Rising Edge of External Input Signal is Detected,Current Counter Value is Stored into the Capture Up Register.
	GTC_ControlSet_CAPT_TCAP0		=	((CSP_REGISTER_T)0X00ul<<19),					//Capture input source is TCAP0
	GTC_ControlSet_CAPT_TCAP1		=	((CSP_REGISTER_T)0X01ul<<19),					//Capture input source is TCAP1
	GTC_ControlSet_CAPT_TCAP2		=	((CSP_REGISTER_T)0X02ul<<19),					//Capture input source is TCAP2
	GTC_ControlSet_CAPT_TCAP3		=	((CSP_REGISTER_T)0X03ul<<19),					//Capture input source is TCAP3
...
typedef enum
{
	...
	GTC_CAPTI    	=	((CSP_REGISTER_T)(0x01ul << 6))       /**< Overflow Interrupt     */
}GTC_IMSCR_TypeDef;  
