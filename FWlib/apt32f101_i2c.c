...
IIC Write Byte
*******************************************************/
void writebyte(int add,int dat)	  
{
    start();

    write8bit(I2C_Address<<1);
    waitack();
    write8bit(add);
    waitack();
...
/*****************************************************
IIC write and Read back
*******************************************************/
void writeRegister(int add,int dat)	  
{	
	do
	{
		writebyte(add,dat);
	}
	while(dat!=readbyte(add));
}
